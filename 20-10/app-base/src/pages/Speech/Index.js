...
/* Adicionar */
import { Platform, Text, View, StyleSheet, SafeAreaView, TouchableHighlight, Button } from 'react-native';
import * as Speech from 'expo-speech';

export default function Espeech({ navigation, navigation: { goBack } }) {
    const speak = () => {
        const thingToSay = 'A prof Leticia é a melhor';
       ...
       <View style={styles.ViewInicial}>
        ...
        <View style={styles.container}>
            <View style={{ paddingVertical: 10 }}> 
                <Button style={{ marginTop: 10 }} title="Pressione para ouvir algumas palavras" onPress={speak} />
            </View>
        </View>
